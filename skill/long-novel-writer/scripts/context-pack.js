...
function build(projectInput, options = {}) {
  ...
  const critical = [
    ...
    ...byPresence('critical', ['state/current-state.md', 'state/current-focus.md', 'state/unresolved-hooks.md', 'state/feedback-rules.json', 'state/style-contract.json', 'state/character-contracts.json', 'state/foreshadowing-index.json', 'state/foreshadowing-progress.json', 'state/hook-agenda.json', 'state/resource-window.json', 'state/plot-unit-window.json', 'state/pacing-ledger.json', 'state/quality-guidance.json', 'state/repair-debt-guidance.json', chapterCard]),
  ];
