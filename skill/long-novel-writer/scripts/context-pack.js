...
function build(projectInput, options = {}) {
  ...
  const critical = [
    ...
    ...byPresence('critical', ['state/current-state.md', 'state/current-focus.md', 'state/unresolved-hooks.md', 'state/feedback-rules.json', 'state/style-contract.json', 'state/character-contracts.json', 'state/foreshadowing-index.json', 'state/foreshadowing-progress.json', 'state/pacing-ledger.json', chapterCard]),
  ];
