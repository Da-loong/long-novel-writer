...
function templates(meta) {
  ...
  return {
    ...
    'settings/agent-runner.json': `${JSON.stringify({ schema_version: '1.0', agent_command: 'claude', model: '', agent_args: ['--dangerously-skip-permissions', '--no-session-persistence'], timeout_ms: 900000, max_attempts: 3, chapter_min_chars: 1200, chapter_max_chars: null, panel_readers: 3, panel_attempts: 2, review_interval: 10 }, null, 2)}\n`,
