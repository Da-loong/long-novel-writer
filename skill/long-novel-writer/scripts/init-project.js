...
function templates(meta) {
  ...
  return {
    ...
    'settings/agent-runner.json': `${JSON.stringify({ schema_version: '1.0', agent_command: 'claude', model: '', agent_args: ['--dangerously-skip-permissions', '--no-session-persistence'], timeout_ms: 900000, max_attempts: 3, chapter_min_chars: 1200, chapter_max_chars: null, panel_readers: 3, panel_models: [], panel_attempts: 2, review_interval: 10, chapter_revision_passes: 2, chapter_reader_review: true, chapter_reader_min_score: 7, chapter_fact_extract: true, chapter_foreshadowing_reconcile: true }, null, 2)}\n`,
