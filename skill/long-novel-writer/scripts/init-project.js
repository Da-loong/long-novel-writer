...
function templates(meta) {
  ...
  return {
    ...
    'settings/agent-runner.json': `${JSON.stringify({ schema_version: '1.1', agent_command: 'claude', model: '', agent_args: ['--dangerously-skip-permissions', '--no-session-persistence'], timeout_ms: 900000, max_attempts: 3, chapter_min_chars: 1200, chapter_max_chars: null, panel_readers: 5, panel_models: [], panel_roles: ['fanqie-editor', 'serial-reader', 'webnovel-structure', 'prose-editor', 'continuity-auditor'], panel_attempts: 2, review_interval: 10, chapter_revision_passes: 2, chapter_reader_review: true, chapter_reader_min_score: 7, chapter_fact_extract: true, chapter_foreshadowing_reconcile: true }, null, 2)}\n`,
    ...
    'settings/market-sources.json': `${JSON.stringify({ schema_version: '1.0', platform: 'fanqie', urls: [], offline_exports: [], cache: 'evidence/snapshots/ranking-cache.json', min_sample: 10, retry: 2, max_cache_hours: 72, rule: 'Populate URLs or offline exports before unattended rank acquisition. A failed acquisition must not be replaced by invented market evidence.' }, null, 2)}\n`,
    ...
    'state/platform-metrics.json': `${JSON.stringify({ schema_version: '1.0', generated_at: null, entries: [], warnings: [], rule: 'Metrics must be imported from actual platform exports.' }, null, 2)}\n`,
