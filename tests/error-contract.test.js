...
for (const script of ['cap-utils.js', 'check-ai-patterns.js', 'check-degeneration.js', 'format-gate.js', 'normalize-punctuation.js', 'init-project.js', 'validate-project.js', 'rank-scan.js', 'context-pack.js', 'chapter-gate.js', 'chapter-transaction.js', 'pilot-review.js', 'import-inventory.js', 'reader-metrics.js', 'handoff.js', 'autopilot.js', 'evidence-audit.js', 'classroom-audit.js', 'workflow-runner.js', 'autopilot-runner.js']) {
